...
import 'package:untitled/timer/controllers/history_controller.dart';
import 'package:untitled/timer/models/history_model.dart';
import 'package:untitled/timer/screens/history_screen.dart';
import 'package:untitled/timer/utils/colors.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                 Text("Focus on Your Task!", style: TextStyle(color: green1 , fontSize: 20, fontWeight: FontWeight.bold),),
                  IconButton(
                    icon: Icon(
                      Icons.history,
                      color: green1,
