...
import 'package:untitled/mood/models/acitvity.dart';
import 'package:untitled/mood/models/mood.dart';
import 'package:untitled/mood/models/moodcard.dart';
import 'package:untitled/mood/widgets/activity.dart';
import 'package:untitled/mood/widgets/moodicon.dart';
...
class _StartPageState extends State<StartPage> {
  ...
  List<Mood> moods = [
    ...
    Mood('assets/surprised.png', 'Surpris', false),
                 ...
                 child: Column(
                   children: [
                     CircleAvatar(
                        radius: 27,
                        child: CircleAvatar(
                          child: Icon(Icons.dashboard , color: Colors.red, size: 30),
                          radius: 25,
             ...
             GestureDetector(
                 ...
                 child: Column(
                   children: [
                     ...
                     radius: 27,
                     child: CircleAvatar(
                       child: Icon(Icons.timer , color: Colors.lightGreen, size: 30),
                       radius: 25,
                       backgroundColor: Colors.white  
                     ),
                     backgroundColor: Colors.lightGreen,
