...
import 'package:untitled/mood/helpers/db_helper.dart';
import 'package:untitled/mood/helpers/mooddata.dart';
import 'package:untitled/mood/models/moodcard.dart';
import 'package:untitled/mood/widgets/mooddaycard.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return loader? Center(child: CircularProgressIndicator()):Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[IconButton(icon: Icon(Icons.show_chart), onPressed:()=> Navigator.of(context).pushNamed('/chart'))],
      ),
